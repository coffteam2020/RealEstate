...
const TextInputFlatLeftIconTouchable = ({
  placeHolder,
  onSubmitEditing,
  hideText,
  maxLength,
    ...
    <Animatable.View animation="fadeIn" style={[styles.container, style]}>
      ...
      <TouchableOpacity onPress={onPress} style={[styles.containerInput]}>
        <TextInput
          ...
          value={value}
          onSubmitEditing={
            onSubmitEditing ? onSubmitEditing : onBlur ? onBlur : () => {}
          }
        ...
        {hasLeftIcon && hasLeftIcon ? (
          <TouchableOpacity
            onPress={onPressIco}
            disabled={icoDisabled && icoDisabled}
            style={styles.rightIcon}>
            <Animatable.View animation="fadeIn">{ico}</Animatable.View>
          </TouchableOpacity>
        ) : null}
      </TouchableOpacity>
    </Animatable.View>
