...
const TextInputFlatLeftIconTouchable = ({ placeHolder, onSubmitEditing, hideText, maxLength, value, props, onPress, onBlur, style, textInputStyle, onChangeText, text, hasLeftIcon, ico, secureText, icoDisabled, onPressIco, keyboardType }) => {
            ...
            <TouchableOpacity onPress={onPress} style={[styles.containerInput]}>
                <TextInput
                    style={[styles.default, textInputStyle || {}, {
                        ...
                        paddingStart: SPACINGS.superLarge,
                    }]}
...
export default TextInputFlatLeftIconTouchable;
