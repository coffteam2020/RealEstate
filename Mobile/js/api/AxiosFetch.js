...
export async function AxiosFetcher({method,
	...
	try {
		...
		console.log('========> RES: ' + customBaseUrl && customBaseUrl || url + '_' + LogManager.parseJsonObjectToJsonString(res?.data));
		...
		console.log('========> ERROR: ' + url + '_' + LogManager.parseJsonObjectToJsonString(error ? error : error?.message));
