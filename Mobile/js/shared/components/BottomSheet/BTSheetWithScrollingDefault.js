...
class BTSheetWithScrollingDefault extends Component {
    constructor(props) {
        super(props);
        this.state = {
            modalVisible: false,
...
BTSheetWithScrollingDefault.propTypes = {
...
BTSheetWithScrollingDefault.defaultProps = {
    animationType: "none",
    height: 260,
    minClosingHeight: 0,
    duration: 300,
...
export default BTSheetWithScrollingDefault;