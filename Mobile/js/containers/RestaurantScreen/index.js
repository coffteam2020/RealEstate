...
export default function RestaurantScreen(props) {
    ...
    const addDataRestaurant = () => {
        ...
        FirebaseService.pushNewItem(
            ...
            JSON.parse(
                JSON.stringify({
                    url: 'https://dcist.com/wp-content/uploads/sites/3/2020/05/200316_DC_empty_restaurants_Turner_02-1500x1000.jpg',
                    ...
                    menu: [
                        {
                            id: 1,
                            nameFood: 'Chicken steamed',
                            price: '150 000'
                        },
                        {
                            id: 2,
                            nameFood: 'Chicken Rice',
                            price: '50 000'
                        },
                        {
                            id: 3,
